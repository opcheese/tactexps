...
(async () => {
    createNftDeployLink(Address.parse("EQCXnq1SWEa-poYLriArmVN79tFspQ2bw1AZbar1Uxs6Gxsz"), Address.parse('0QCNGf2fxCJx7sFH83JUayIFh9Y5a9KG8rG-6wDV1r1gW_ij'), toNano("0.06"), "https://raw.githubusercontent.com/opcheese/tactexps/main/nft1.png", 0n);
